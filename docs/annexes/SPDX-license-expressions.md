# Annex C SPDX license expressions (Normative)

## C.1 Overview <a name="C.1"></a>
...
## C.2 Case sensitivity <a name="C.2"></a>
...
## C.3 Simple license expressions <a name="C.3"></a>
...
## C.4 Composite license expressions <a name="C.4"></a>

### C.4.1 Introduction <a name="C.4.1"></a>
...
Nested parentheses can also be used to specify an order of precedence which is discussed in more detail in [C.4.5](#C.4.5).

### C.4.2 Disjunctive "OR" operator <a name="C.4.2"></a>
...
### C.4.3 Conjunctive "AND" operator <a name="C.4.3"></a>
...
### C.4.4 Additive "WITH" operator <a name="C.4.4"></a>
...
### C.4.5 Order of precedence and parentheses <a name="C.4.5"></a>
...
### C.4.6 License expressions in RDF <a name="C.4.6"></a>
